...
public class StructuredProfileAttribute<T extends Object, V extends Attribute>
		extends StructuredAttribute<T, V> implements
		IProfileAttribute {
	...
	public void setWriteRelationShipTypes(boolean b) {
		...
		for(Object o : this){
			if(o instanceof IProfileAttribute)
